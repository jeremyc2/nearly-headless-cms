...
export const useEntryEditorDeleteMutation = ({
  ...
  useMutation({
    // oxlint-disable-next-line effecttsgo/async-function -- [EH-020] deletion sequence requires awaited server state.
    mutationFn: async () => {
      if (
...
useEntryEditorPurgeMutation = ({
  ...
  return useMutation({
    ...
    // oxlint-disable-next-line effecttsgo/async-function -- [EH-055] React query callback awaits navigation.
    onSuccess: async () => {
...
useEntryEditorSaveMutation = ({
  ...
  useMutation({
    ...
    // oxlint-disable-next-line effecttsgo/async-function -- [EH-057] React query error callback awaits the latest server state.
    onError: async (error) => {
