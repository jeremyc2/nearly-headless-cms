...
import { useContentListController } from "./content-list-controller.ts";
...
ContentListEntries = ({
  ...
  readonly controller: ReturnType<typeof useContentListController>;
}) => (
  <div className="entry-list">
    {controller.entries.data?.items.map((entry) => (
      <Link
        key={entry.id}
        className="entry-row"
