...
const OverviewBuildPanel = ({
  rebuild,
}: Pick<OverviewState, "rebuild">): React.JSX.Element => (
 ...
 OverviewQueuesPanel = (): React.JSX.Element => (
  <section className="panel">
    ...
    <Link className="queue-row" to="/content/$contentTypeId" params={{ contentTypeId: "comment" }}>
 ...
 OverviewSignalGrid = ({
  ...
  OverviewState,
  "assetsCount" | "counts" | "draftPostCount" | "pendingCommentCount"
>): React.JSX.Element => (
