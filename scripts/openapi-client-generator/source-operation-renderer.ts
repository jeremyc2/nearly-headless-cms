...
const appendParameterGroup = <Input extends AppendParameterGroupInput>(
  ...
  sourceOperationRenderer = {
    ...
    operationInputType(operation: GeneratedOperation) {
      ...
      appendParameterGroup({ fields, group: pathType, name: "path" });
      appendParameterGroup({ fields, group: queryType, name: "query" });
      appendParameterGroup({ fields, group: headerType, name: "headers" });
