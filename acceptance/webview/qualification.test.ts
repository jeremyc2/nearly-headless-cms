...
const ACCEPTANCE_RUN_COUNT = 10,
  ...
  // oxlint-disable-next-line effecttsgo/async-function -- [EH-053] qualification assertions compose awaited WebView navigation and evaluation.
...
describe("Bun WebView qualification", () => {
  selectAcceptanceTest(enabled)(
    ...
    async () => {
      // oxlint-disable-next-line effecttsgo/async-function -- [EH-061] recursive acceptance retries compose native WebView Promise operations.
